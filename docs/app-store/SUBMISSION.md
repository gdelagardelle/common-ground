...
Answer based on local-first design (see [privacy policy](../privacy/index.html)):
...
3. **What to Test:** custody calendar, expenses, court export, co-parent invite
...
3. Paste **Review Notes** from [metadata.md](metadata.md)
